    ...
    <section className="relative pt-28 md:pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 items-end">
          <div>
            <h1 className="font-heading text-5xl sm:text-6xl font-bold text-foreground leading-[1.02] tracking-tight mb-0">
              Kami percaya
              <br />
              infrastruktur yang
              <br />
          ...
          <div className="lg:pb-2">
            ...
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              {/* <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                <span className="text-primary font-bold font-heading text-xs">
                  SW
                </span>
              </div> */}
